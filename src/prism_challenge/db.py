...
SCHEMA = (
    ...
    "architecture_graph TEXT NOT NULL, training_graph TEXT NOT NULL, mermaid TEXT NOT NULL,"
    "architecture_summary TEXT NOT NULL, training_summary TEXT NOT NULL, created_at TEXT NOT NULL);"
    ...
    "CREATE TABLE IF NOT EXISTS component_review_holds ("
    "id TEXT PRIMARY KEY, submission_id TEXT NOT NULL UNIQUE, status TEXT NOT NULL,"
    "reason TEXT NOT NULL, confidence REAL NOT NULL, payload TEXT NOT NULL,"
    ...
    "id TEXT PRIMARY KEY, submission_id TEXT NOT NULL, event TEXT NOT NULL, scope TEXT NOT NULL,"
    "architecture_id TEXT, training_variant_id TEXT, from_hotkey TEXT, to_hotkey TEXT,"
